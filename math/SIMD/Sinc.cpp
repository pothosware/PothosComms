...
namespace detail
{
    ...
    template <typename T>
    static Pothos::Util::EnableIfXSIMDSupports<T, void> sinc(const T* in, T* out, size_t len)
    {
    ...
    template <typename T>
    static inline Pothos::Util::EnableIfXSIMDDoesNotSupport<T, void> sinc(const T* in, T* out, size_t len)
    {
